/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 51d8a9ca9bc0d3513026d11082b206bc)
...
interface __BaseEnv_Env {
	...
	DB: D1Database;
	ASSETS: Fetcher;
	FIREBASE_CLIENT_EMAIL: "firebase-adminsdk-fbsvc@bible-quest-e00ee.iam.gserviceaccount.com";
	FIREBASE_PRIVATE_KEY: "-----BEGIN PRIVATE KEY-----\\nqSKibppZprvBxE229F+hBRk0\n-----END PRIVATE KEY-----";
	VITE_API_URL: "https://quest.vidarave.com/api/v1";
	JWT_SECRET: string;
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "FIREBASE_CLIENT_EMAIL" | "FIREBASE_PRIVATE_KEY" | "VITE_API_URL" | "JWT_SECRET">> {}
}
